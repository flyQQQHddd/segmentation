...
config = dict(
    ...
    source_pipeline = dict(
        ...
        dataset = dict(
            type="PNGDataset",
            csv_file=r'/home/featurize/work/code/dataset/Jianli_8cm.csv',
    ...
    target_pipeline = dict(
        ...
        dataset = dict(
            type="PNGDataset",
            csv_file=r'/home/featurize/work/code/dataset/Hainan_A5_2cm_train.csv',
            image_dir=r'/home/featurize/data/TransferDataset/image/'),
    ...
    # Target Dataset with label
    target_pipeline_merge_label = dict(
